...
{
       0,    29,    29,    31,    32,    33,    35,    36,    37,    40,
      41,    42,    45,    46,    47,    48,    49,    50,    51,    54,
      55,    56,    58,    59,    61,    62,    63,    65,    66,    68,
      69,    71,    73,    75,    77,    79,    80,    81,    83,    84,
      85,    86,    87,    88,    89,    92,    93,    95,    99,   101,
     103,   106,   107,   110,   111,   112,   113,   115,   116
};
#endif
...
/* Line 1806 of yacc.c  */
#line 70 "parse.y"
    {(yyval) = reg; clean_string((char *)(yyvsp[(1) - (1)])); len_string = strlen((char *)(yyvsp[(1) - (1)])) + 1; printf("\%r%d = internal constant [%d x i8] c\"%s\\00\"\n", reg, len_string, (char *)(yyvsp[(1) - (1)])); reg++;}
    break;
...
/* Line 1806 of yacc.c  */
#line 72 "parse.y"
    {(yyval) = reg; printf("\%r%d = fadd i32 0.0, %f\n", reg, (yyvsp[(1) - (1)])); reg++;}
    break;
